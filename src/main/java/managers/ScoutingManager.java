...
import strategies.IScoutingStrategy;
import strategies.ProbeScoutingStrategy;
...
public class ScoutingManager implements IBroodWarManager{
    ...
    private IScoutingStrategy scoutingStrategy = new ProbeScoutingStrategy();

    @Override
    public void manage() {
            if(this.scout != null){
                this.scoutingStrategy.scout(this.game, this.baseInfoTracker, this.scout);
            }
            else{
